          ...
          <div class="structure__block">
            ...
            <ol>
              <li class="structure__list__item">Воспользуйтесь поиском или навигацией по каталогу, чтобы выбрать интересующий вас товар.
                (Если нужного вам товара нет на складе или в каталоге, вы можете отправить запрос на контактную почту <a class="_link"  :href = "'mailto:' + SETTINGS.email">{{ SETTINGS.email }}</a> с указанием наименования, модели и производителя товара, после чего с вами свяжется наш менеджер).</li>
