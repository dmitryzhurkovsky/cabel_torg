          ...
          <div class="catalog__block">
            ...
            <div class="content-block slider_subcategory__block">
              ...
              <div class="content-block__list">
                <div class="content-block__item product-row" v-if = "catalogData.length !== 0 && VIEW_TYPE === 'row'">
                  <CatalogListItem 
                ...
                <div class="content-block__item product-table" v-if = "catalogData.length !== 0 && VIEW_TYPE === 'table'">
                  <CatalogCardItem 
                    v-for   = "item in catalogData"
                    :key    = "item.id"
                    :card   = item
...
<script>
  ...
  export default defineNuxtComponent({
    ...
    async asyncData (query) {
      console.log(query);
      const request = await $fetch(useRuntimeConfig().public.NUXT_APP_API_URL + 'products'); 
