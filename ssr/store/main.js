...
export default {
  ...
  actions: {
    async GET_PARTNERS({ commit }){
      try {
        const response = await axios.get(useRuntimeConfig().public.NUXT_APP_API_URL + 'service_entities/partners');
    ...
    async GET_NEWS({ commit }){
      try {
        const response = await axios.get(useRuntimeConfig().public.NUXT_APP_API_URL + 'service_entities/articles');
    ...
    async GET_BANNERS({ commit }){
      try {
        const response = await axios.get(useRuntimeConfig().public.NUXT_APP_API_URL + 'service_entities/banners');
    ...
    async GET_SETTINGS({ commit }){
      try {
        const response = await axios.get(useRuntimeConfig().public.NUXT_APP_API_URL + 'service_entities/vendor_info/1');
