...
class Product(Base1CModel):
    ...
    vendor_code = Column(String, nullable=False, unique=True, index=True)  # It's a slug field.
    ...
    category_id = Column(Integer, ForeignKey('categories.id', ondelete='CASCADE'), index=True)  # o2m
